...
export const mockBankStatementLines: BankStatementLine[] = [
  {
    ...
    authorizationCode: "AUTH-7891", mcc: "3000", reconciliationStatus: "Unmatched",
  },
  {
  ...
  },
  {
    ...
    authorizationCode: "AUTH-3344", mcc: "7372", reconciliationStatus: "Unmatched",
  },
  {
...
export const mockSystemTransactions: SystemTransaction[] = [
  {
    ...
    transactionDate: "2025-03-15", merchantName: "S&P Restaurant", purpose: "Eating Places / Restaurants",
    amount: 2850, currency: "THB",
    status: "Approved", reconciliationStatus: "Unmatched", source: "User",
    claimId: "c1", expenseCategory: "Meals",
  },
  {
    id: "SYS-002", type: "claim", createdBy: "u1",
    transactionDate: "2025-02-14", merchantName: "OfficeMate", purpose: "Stationery / Office Supplies",
    amount: 4500, currency: "THB",
    status: "Approved", reconciliationStatus: "Unmatched", source: "User",
    claimId: "c2", expenseCategory: "Office Supplies",
  },
  {
    id: "SYS-003", type: "claim", createdBy: "u1",
    transactionDate: "2025-02-25", merchantName: "Centara Hotel Chiang Mai", purpose: "Hotels / Lodging",
    amount: 4800, currency: "THB",
    status: "Approved", reconciliationStatus: "Unmatched", source: "User",
    claimId: "c3", expenseCategory: "Travel",
  },
  {
    id: "SYS-004", type: "expense", createdBy: "u1",
    transactionDate: "2025-02-07", merchantName: "LINE MAN Food Delivery", purpose: "Eating Places / Restaurants",
    amount: 450, currency: "THB",
    status: "Approved", reconciliationStatus: "Unmatched", source: "User",
    expenseCategory: "Meals",
  },
  {
    id: "SYS-005", type: "expense", createdBy: "u1",
    transactionDate: "2025-02-10", merchantName: "Amazon Café", purpose: "Eating Places / Restaurants",
    amount: 3500, currency: "THB",
    status: "Approved", reconciliationStatus: "Unmatched", source: "User",
    expenseCategory: "Meals",
  },
  {
    id: "SYS-006", type: "expense", createdBy: "u1",
    transactionDate: "2025-02-27", merchantName: "Grab Transport", purpose: "Taxicabs / Rideshares",
    amount: 380, currency: "THB",
    status: "Approved", reconciliationStatus: "Unmatched", source: "User",
    expenseCategory: "Transportation",
  },
  {
    id: "SYS-007", type: "expense", createdBy: "u1",
    transactionDate: "2025-01-18", merchantName: "Starbucks Siam Paragon", purpose: "Eating Places / Restaurants",
    amount: 520, currency: "THB",
    status: "Approved", reconciliationStatus: "Unmatched", source: "User",
    expenseCategory: "Meals",
  },
];
