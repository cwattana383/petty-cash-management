...
const ACCOUNTING_ITEMS: AccountingItem[] = [
  ...
  { id: "TXN2026050800009", merchantName: "Thanit Boonmee", description: "Team building dinner", amount: 4200.00, status: "Accounting Review", date: "2026-05-08", fileName: "TeamDinner_TaxInvoice_20260508.pdf", docType: "Tax Invoice", approvalStatus: "Accounting Review", approvalStatusTone: "info", documentStatus: "Validated", documentStatusTone: "success" },
  ...
  {
    id: "TXN2026050800008",
    merchantName: "Anantara Riverside Bangkok",
    description: "Lodging — Hotels and Motels",
    amount: 2800.00,
    status: "Accounting Review",
    date: "2026-05-08",
    fileName: "Anantara_TaxInvoice_20260508.pdf",
    docType: "Tax Invoice",
    approvalStatus: "Verified",
    approvalStatusTone: "success",
    documentStatus: "Validated",
    documentStatusTone: "success",
    cardholderName: "Malee Chaiyo",
    purpose: "Hotel one night — overnight stay during Bangkok client visit",
    expenseType: "Travel",
    subExpenseType: "Accommodation — Domestic",
    vatType: "Claim 100",
    glAccount: "5300-005 — Travel - Accommodation",
    project: null,
    vatAmount: 183.18,
    ...
    approvalHistory: [
      ...
      { id: "evt-008-2", actor: "cardholder", actorName: "Malee Chaiyo", title: "Claim created", statusBadge: "NOT_STARTED", timestamp: "2026-05-08T20:15:00Z" },
