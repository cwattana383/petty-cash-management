          ...
          <Card>
            ...
            <CardContent className="pt-0 space-y-4">
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-sm text-muted-foreground">Claims must be approved within</span>
                  <Input
                    type="number"
                    ...
                    min={1}
                  />
                  <span className="text-sm text-muted-foreground">day(s) from submission date</span>
                </div>
              </div>
