...
export const mockCompanyIdentities: CompanyIdentity[] = [
  {
    id: "1",
    companyCode: "CORP-01",
    legalNameTh: "บริษัท ABC จำกัด (มหาชน)",
    legalNameEn: "ABC Public Company Limited",
    effectiveStartDate: "2020-01-01",
    effectiveEndDate: "",
    status: "Active",
    taxIds: [
      { id: "t1", taxId: "0107536000269", branchType: "สำนักงานใหญ่", branchNo: "", isPrimary: true },
      { id: "t2", taxId: "0107536000270", branchType: "สาขา", branchNo: "00001", isPrimary: false },
    ],
    aliases: ["ABC PCL", "เอบีซี มหาชน"],
    ...
    addressAliases: ["123 สุขุมวิท คลองเตย กทม", "ABC สุขุมวิท"],
